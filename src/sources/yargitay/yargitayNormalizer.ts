...
import type { LiveYargitaySearchResult } from "./liveTypes.js";

const BASE_URL = "https://emsal.yargitay.gov.tr";

export function normalizeYargitaySearchResults(raw: unknown): LiveYargitaySearchResult[] {
...
export function extractYargitayFullText(html: string): string {
...
export function buildYargitayDecision(
...
export function buildYargitayEmptyTrace(
  query: string,
