...
import { realWorldPhysicianQuestions } from "./realWorldPhysicianQuestions.js";
...
async function main() {
  ...
  const outDir = "exports/physician-real-world-benchmark";
  ...
  console.log("====================================================");
  console.log("Starting Real-World Physician Question Beta Benchmark Suite");
  ...
  try {
    const report = await runBenchmark({
      ...
      limit,
      outDir,
      questions: realWorldPhysicianQuestions
    });
    ...
    // Save updated reports to physician-real-world-benchmark with specific filenames
...
`;
    ...
    console.log("\n====================================================");
    console.log("Real-World Benchmark Completed successfully!");
    ...
    console.error("Real-World Benchmark runner failed with critical error:", err);
    process.exit(1);
  }
}
